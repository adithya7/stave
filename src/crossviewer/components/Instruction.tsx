...
function Instruction() {
  return (
    <div>
      ...
      <p style={{marginLeft: "2em"}}>We understand that this decision is not always easy. To help you with this, we compiled a bunch of examples. You can quickly glance through them using the “See Examples” button on the tool.</p>
